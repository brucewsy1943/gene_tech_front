...
import com.genetech.service.ArticleService;
import com.genetech.service.ColumnService;
...
public class ArticleController {
	...
	@Autowired
	 private com.genetech.utils.UploadUtils UploadUtils;
	 ...
	 public ResponseBean add(@RequestBody ArticleDto article, HttpServletRequest request) throws Exception{
		...
		if (article.getExpiredtimetype()==0) {
		  ...
		  for (Integer integer : integers) {
		   ...
		   //插入后插入日志表中
			com.genetech.bean.Logger loggers  = new com.genetech.bean.Logger();
